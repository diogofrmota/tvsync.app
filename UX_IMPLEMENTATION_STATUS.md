...
Scope: the original repository-wide audit is retained below as a baseline. The implementation updates in this section supersede baseline rows for shared shells, navigation, footer, poster cards, shared states, Home, Home tests, Search presentation, responsive grids, authentication requirements 1.3 through 1.6, and the authenticated Movies library in section 2.1.
